...
Thank you for your interest in contributing to WhisperKey! This guide will help you get started with contributing to this open source speech-to-text application.

## 📖 Philosophy

WhisperKey aims to be the most forkable speech-to-text app. The goal is to create both a useful tool and a foundation for others to build upon—a well-patterned, simple codebase that serves the community. We prioritize:
...
2. **Clone your fork**:
   ...
   ```bash
   git clone git@github.com:YOUR_USERNAME/WhisperKey.git
   cd WhisperKey
   ```
...
3. **Add upstream remote**:
   ...
   ```bash
   git remote add upstream git@github.com:levelup-app-factory/whisperkey.git
   ```
...
WhisperKey follows a clean architecture pattern:
...
1. **Search existing issues** at [github.com/levelup-app-factory/whisperkey/issues](https://github.com/levelup-app-factory/whisperkey/issues)
2. **Check discussions** at [github.com/levelup-app-factory/whisperkey/discussions](https://github.com/levelup-app-factory/whisperkey/discussions)
...
1. **Search existing discussions** at [github.com/levelup-app-factory/whisperkey/discussions](https://github.com/levelup-app-factory/whisperkey/discussions)
2. **Check common feature requests**:
   - [Post-processing / Editing Transcripts](https://github.com/levelup-app-factory/whisperkey/discussions/168)
   - [Keyboard Shortcuts / Hotkeys](https://github.com/levelup-app-factory/whisperkey/discussions/211)

### Submitting a Feature Request

1. Go to [Discussions](https://github.com/levelup-app-factory/whisperkey/discussions)
...
4. Describe your feature idea including:
   ...
   - How it fits with WhisperKey's philosophy
...
1. **Search existing issues and PRs** - Check both open AND closed issues and pull requests. Someone may have already addressed this, or there may be a reason it was closed.
   - [Open issues](https://github.com/levelup-app-factory/whisperkey/issues)
   - [Closed issues](https://github.com/levelup-app-factory/whisperkey/issues?q=is%3Aissue+is%3Aclosed)
   - [Open PRs](https://github.com/levelup-app-factory/whisperkey/pulls)
   - [Closed PRs](https://github.com/levelup-app-factory/whisperkey/pulls?q=is%3Apr+is%3Aclosed)
...
2. **If something was previously closed** - If you want to revisit a closed issue or PR, you need to:
   ...
   - Gather community feedback first via [Discussions](https://github.com/levelup-app-factory/whisperkey/discussions)
   - Link to that discussion in your PR

3. **Get community feedback for features** - PRs with demonstrated community interest are **much more likely to be merged**. Start a discussion, get feedback, and link to it in your PR. This helps ensure WhisperKey stays focused and useful for the most people without becoming bloated.

Community feedback is essential to keeping WhisperKey the best it can be for everyone. It helps prioritize what matters most and prevents feature creep.
...
7. **Create a Pull Request**:
   - Go to the [WhisperKey repository](https://github.com/levelup-app-factory/whisperkey)
   ...
   **Remember:** PRs with community support are prioritized. If you haven't already, start a [discussion](https://github.com/levelup-app-factory/whisperkey/discussions) to gather feedback before or alongside your PR. It is not explicitly required to gather feedback, but it certainly helps your PR get merged faster.
...
- **Discussions**: Ask questions in [GitHub Discussions](https://github.com/levelup-app-factory/whisperkey/discussions)
- **Email**: Reach out at [support@whisperkey.org](mailto:support@whisperkey.org)

## 📜 License

By contributing to WhisperKey, you agree that your contributions will be licensed under the MIT License. See [LICENSE](LICENSE) for details.

---

**Thank you for contributing to WhisperKey!** Your efforts help make speech-to-text technology more accessible, private, and extensible for everyone.
